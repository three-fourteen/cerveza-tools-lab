...
- **Mutaciones:** acciones explícitas (`updateBrew`, `addHop`, `updateHop`, `removeHop`, `resetBrew`) con validación central. Las herramientas aceptan esquemas cerrados y listas blancas de campos.
